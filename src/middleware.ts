	...
	if (!normalizedPath.startsWith("/api/")) {
		...
		response.headers.set(
			...
			[
				...
				"connect-src 'self' https://test.994613.xyz https://owo.imaegoo.com https://challenges.cloudflare.com https://static.cloudflareinsights.com https://cloudflareinsights.com",
